...
def should_show_notification():
    """Check if notification should be shown (23 hours since last play)"""
...
def show_notification(sense_hat):
    """
    Show the notification: flash LED grid and display "Play" message
    ...
    sense_hat.show_message("time to play", scroll_speed=0.06, text_colour=[255, 255, 0])
